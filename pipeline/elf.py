...
class ElfRela:
    ...
    def __init__(self, r_offset=0, r_info_sym=0, r_info_type: ARM_RELOC_TYPE=ARM_RELOC_TYPE.R_ARM_NONE, r_addend=0) -> None:
        self.r_offset: int = r_offset
        self.r_info_sym: int = r_info_sym
        self.r_info_type: ARM_RELOC_TYPE = r_info_type
    ...
    def read(data: bytes, offset: int) -> 'ElfRela':
        ...
        r_info_sym = r_info >> 8
        r_info_type = ARM_RELOC_TYPE(r_info & 0xFF)
...
class ElfRelaSec(ElfSection):
    ...
    def _prepare_for_write(self) -> None:
        ...
        self.header.sh_type = SHT.SHT_RELA
        super()._prepare_for_write()
